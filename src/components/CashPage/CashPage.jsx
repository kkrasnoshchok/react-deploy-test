...
export default function CashPage(props) {
  ...
  return (
    <div className="сashPage">
      <div className="cashBg"></div>
      <div className="container">
        <div className="finalInner">
          ...
          <div className="сashResults">
            <div className="cashResult money">
              а точніше :  <span>{scoreMoney()} грн</span>{" "}
            </div>
          </div>
          <div className="cashRestartButton">
            <button className="cashRestButton" onClick={setQuizState}>
              почати знову!
            </button>
          </div>
